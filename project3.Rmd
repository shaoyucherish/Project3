...
From the correlation graph above, we can see that the following variables seem to be moderately correlated:
  - `n_tokends_contents`, `n_unique_tokens`, `n_non_stop_words`, `n_non_stop_unique_tokens`, `num_hrefs`, `num_imgs`
...
For further EDA, we are plotting graphs to see trends between different variables with respect to the number of shares.
