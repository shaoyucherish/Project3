...
Plot between title subjectivity and number of shares :
We can inspect the trend of the shares as a function of title subjectivity. 
```{r}
ggplot(data = newsTrain, aes(x = title_subjectivity, y = shares)) +
...
ggplot(data = newsTrainday, aes(x=publish_weekday, y=total_shares)) +
  geom_col(color = "blue")+
...
```{r}
ggplot(data = newsTrain, aes(x = num_imgs, y = shares)) +
  geom_point(color = "blue") +
